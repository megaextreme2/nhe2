...
import com.tcc.barbersclub.model.repository.UsuarioRepository;
...
public class UsuarioService {
	...
	public List<Usuario> findAll() {
		List<Usuario> _usuario = usuarioRepository.findAll();
		return _usuario;
	}
	
	public List<Usuario> findAllByStatus(String status) {
		List<Usuario> _usuario = usuarioRepository.findAllByStatusUsuario(status);
		return _usuario;
	}
	...
	@Transactional
	public Usuario edit(MultipartFile file, long id, Usuario usuario) {
		Optional<Usuario> _usuario = usuarioRepository.findById(id);
